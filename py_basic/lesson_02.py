...
while True:
    ...
    if task == '1':
        ...
        while True:
            ...
            print('-' * 30 + 'Второй вариант' + '-' * 30)
            new_list1 = input('Введите числа через пробел: ').split()
            print('new_list1: ', new_list1)
            for i in range(1, len(new_list1), 2):
                new_list1.insert(i - 1, new_list1.pop(i))
        ...
        while True:
            ...
            if input('Для вывода аналитики - "Q", для ввода следующего товара - "Enter": ').upper() == "Q":
                break
